...
import meetup from '../../assets/img/meetup.jpg';
        ...
        <Row className='process-row'>
            ...
            <Row className='process-card' >
                ...
                <Col lg={3} style={{display: "flex", alignItems: "center", justifyContent: "center"}}>
                    <NavLink to="https://chat.whatsapp.com/DDP6L6KfFSsBEGq450BKn8" target='_blank' className='contribute-btn'>
                        Join Group &nbsp;
            ...
            <p className='para note'>
                ...
                <span className='gradient-text'>#</span> Both <b>AWS</b> and <b>Mohan Babu University</b> <i>Terms of Conduct</i> apply.<br /><br />
            ...
            <p className='para-process'>
            Join AWS Cloud Club at Mohan Babu University on Meetup.com
            </p>
            <div className='more-padding'>
            <Row style={{justifyContent: "center", marginTop: "30px"}} className='process-card' >
                ...
                <Col lg={3} style={{display: "flex", alignItems: "center", justifyContent: "center"}}>
                    <NavLink to="https://www.meetup.com/aws-cloud-club-at-mohan-babu-university/" target='_blank' className='contribute-btn'>
                        Join Meetup.com &nbsp;
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-arrow-right" viewBox="0 0 16 16">
                            <path fill-rule="evenodd" d="M1 8a.5.5 0 0 1 .5-.5h11.793l-3.147-3.146a.5.5 0 0 1 .708-.708l4 4a.5.5 0 0 1 0 .708l-4 4a.5.5 0 0 1-.708-.708L13.293 8.5H1.5A.5.5 0 0 1 1 8"/>
                        </svg>
            ...
            <Row style={{justifyContent: "center", marginTop: "30px"}} className='process-card' >
                ...
                <Col lg={3} style={{display: "flex", flexDirection:"column", alignItems: "center", justifyContent: "center"}}>
                    <NavLink to="https://www.linkedin.com/company/aws-mbu/" target='_blank' className='contribute-btn'>
                    ...
                    <NavLink to="https://github.com/awsccmbu" target='_blank' className='contribute-btn' style={{marginTop: "20px"}}>
