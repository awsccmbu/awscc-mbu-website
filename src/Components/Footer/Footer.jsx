            ...
            <Col lg={4}>
                <Row>
                    <Col md={12}>
                        ...
                        <NavLink to="tel:+917842348377" target="_blank" className="useful-links" style={{ fontFamily: "sans-serif" }}>
                        ...
                        <br />
                        <NavLink to="mailto:awsclubmbu@gmail.com" target="_blank" className="useful-links">
                ...
                <div style={{position: "absolute", left: 30, bottom: 0}} className="chennai-identity">
                    <img src={} alt="Tiruoathi Footer Logo" width={200} />
                    
                    <img src={} alt="Temple Logo" width={200} />
                </div>
            </Col>
                ...
                <Col lg={4}>
                    <Row className="useful-links-one">
                        ...
                        <h5 className="side-head" style={{marginTop: "15px"}}>Contribute</h5>
                            <NavLink to= "mailto:awsclubmbu@gmail.com?subject=Intrest%20to%20Present%20a%20topic%20-%20Reg" target="_blank" className="useful-links">
                            <GradientBoxIcon />&nbsp;
                            Present Topic
                            </NavLink> <br />
                            ...
                            <NavLink to= "mailto:awsclubmbu@gmail.com?subject=Intrest%20to%20Sponsor%20an%20Event%20-%20Reg" target="_blank" className="useful-links">
                            <GradientBoxIcon />&nbsp;
                            Sponsor
                            </NavLink>
                        </Col>
                ...
                <Col lg={4} className="footer-right">
                    ...
                    <p className="disclaimer">
                        <i>
                            <sub> This website is managed by <b>AWS Cloud Club Mohan Babu Univeristy - Tirupati</b> and is independent of any affiliation with Amazon Web Services, Inc.
                        ...
                        <br />
                        <small style={{textAlign: "center"}}>Designed &amp; Developed by <NavLink className="footer-link gradient-text" target="_blank" to='https://www.linkedin.com/in/rahul-kothuri-565717186/'>Rahul Kothuri</NavLink> and <NavLink className="footer-link gradient-text" target="_blank"  to="https://www.linkedin.com/in/leena-geepalem/">Leena G</NavLink><br /></small>
